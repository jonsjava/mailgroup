...
FCKConfig.BaseHref = '<?php include("../../config.inc.php");print $web_addr; ?>' ;
...
FCKConfig.SpellerPagesServerScript = '/speller/server-scripts/spellchecker.php' ;	// Available extension: .php .cfm .pl
